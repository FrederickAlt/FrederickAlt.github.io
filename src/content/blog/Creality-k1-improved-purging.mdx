...
Because of this i reverse engineered their binary and did this mod for improved purging. The mod can be downloaded from [my GitHub here](https://github.com/FrederickAlt/CREALITY-K1-AND-K1-MAX-CFS-RETRUDE-BEFORE-CUT-MOD/tree/master?tab=readme-ov-file).
